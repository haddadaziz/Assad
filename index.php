    ...
    <nav class="bg-maroc-red text-white fixed w-full z-50 shadow-lg transition-all duration-300" id="navbar">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-8 font-semibold text-sm uppercase tracking-wide">
                <a href="#accueil" class="hover:text-yellow-300 transition relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-300 after:transition-all hover:after:w-full">Accueil</a>
                <a href="#asaad" class="hover:text-yellow-300 transition relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-300 after:transition-all hover:after:w-full">Asaad</a>
                <a href="#animaux" class="hover:text-yellow-300 transition relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-300 after:transition-all hover:after:w-full">Nos Animaux</a>
                <a href="#visites" class="hover:text-yellow-300 transition relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-0 after:h-0.5 after:bg-yellow-300 after:transition-all hover:after:w-full">Visites</a>
            </div>

            <div class="hidden md:flex items-center space-x-4">
                <a href="login.php" class="text-white hover:text-yellow-200 font-medium px-4 py-2 border border-transparent hover:border-white rounded transition">
                    <i class="fa-solid fa-user mr-2"></i>Connexion
                </a>
                <a href="register.php" class="bg-maroc-green hover:bg-green-800 text-white px-6 py-2 rounded-full font-bold shadow-md transition transform hover:scale-105 border border-green-700">
                    Inscription
                </a>
            </div>
        ...
        <div class="container mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-12 items-center pt-20">
            <div class="text-white space-y-6">
                ...
                <h1 class="font-headings text-5xl md:text-7xl font-extrabold leading-tight drop-shadow-lg">
                    Bienvenue sur<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-200">le territoire d'Asaad</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-100 max-w-lg leading-relaxed">
                    Explorez la richesse de la faune africaine et marocaine. Rejoignez l'aventure pour réserver vos parcours exclusifs.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    ...
                    <a href="#animaux" class="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white text-white text-center px-8 py-4 rounded-lg font-bold text-lg transition">
                        Découvrir le parc
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border-t-4 border-maroc-red flex flex-col md:flex-row">
                ...
                <div class="md:w-1/2 p-10 md:p-16 flex flex-col justify-center space-y-6">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Le Lion de l'Atlas est plus qu'un animal, c'est l'emblème de notre nation. Asaad vous accueille pour vous faire découvrir les secrets de son espèce, aujourd'hui éteinte à l'état sauvage mais préservée ici.
                    </p>
                    <div class="grid grid-cols-2 gap-4 text-sm font-semibold text-gray-700">
                        <div class="flex items-center gap-2"><i class="fa-solid fa-weight-hanging text-maroc-red"></i> 200 kg</div>
                        <div class="flex items-center gap-2"><i class="fa-solid fa-ruler-horizontal text-maroc-red"></i> 2.80 m</div>
                    </div>
                    <button class="w-max px-6 py-3 border-2 border-maroc-red text-maroc-red font-bold rounded-lg hover:bg-maroc-red hover:text-white transition mt-4">
...
<section id="animaux" class="py-20 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-4xl mx-auto bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm mb-12">
                <form action="" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div class="w-full md:w-1/3">
                        ...
                        <div class="relative">
                            <select name="habitat" class="w-full appearance-none bg-white border border-gray-300 text-gray-700 py-3 px-4 pr-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-maroc-green focus:border-transparent cursor-pointer">
                    ...
                    <div class="w-full md:w-1/3">
                        ...
                        <div class="relative">
                            <select name="pays" class="w-full appearance-none bg-white border border-gray-300 text-gray-700 py-3 px-4 pr-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-maroc-green focus:border-transparent cursor-pointer">
                    ...
                    <div class="w-full md:w-1/3">
                        <button type="submit" class="w-full bg-maroc-green hover:bg-green-800 text-white font-bold py-3 px-4 rounded-lg transition shadow-md flex items-center justify-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 border border-gray-100 flex flex-col">
                    <div class="h-64 overflow-hidden relative">
                        <img src="https://images.unsplash.com/photo-1547721064-da6cfb341d50?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Lion" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="mt-auto border-t border-gray-100 pt-3 flex justify-between items-center">
                            ...
                            <a href="#" class="text-maroc-red hover:bg-red-50 p-2 rounded-full transition"><i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 border border-gray-100 flex flex-col">
                    <div class="h-64 overflow-hidden relative">
                        <img src="https://images.unsplash.com/photo-1557008075-7f2c5efa4cfd?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Girafe" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                        <div class="absolute top-3 right-3 bg-white/90 backdrop-blur text-xs font-bold px-2 py-1 rounded text-gray-800 shadow-sm">
                ...
                <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 border border-gray-100 flex flex-col">
                    <div class="h-64 overflow-hidden relative">
                        <img src="https://images.unsplash.com/photo-1570042770669-709772a832c6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Zèbre" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                        <div class="absolute top-3 right-3 bg-white/90 backdrop-blur text-xs font-bold px-2 py-1 rounded text-gray-800 shadow-sm">
                 ...
                 <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 border border-gray-100 flex flex-col">
                    <div class="h-64 overflow-hidden relative">
                        <img src="https://images.unsplash.com/photo-1535591273668-578e31182c4f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Macaque" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                        <div class="absolute top-3 right-3 bg-white/90 backdrop-blur text-xs font-bold px-2 py-1 rounded text-gray-800 shadow-sm">
                            <i class="fa-solid fa-location-dot text-maroc-red mr-1"></i> Maroc
                        </div>
                    </div>
            ...
            <div class="max-w-4xl mx-auto bg-white p-2 rounded-full shadow-xl border border-gray-200 mb-16 transform -translate-y-4">
                <form action="" method="GET" class="flex flex-col md:flex-row items-center p-2 gap-2">
                    ...
                    <div class="w-full md:w-auto px-4">
                        <select name="date" class="w-full bg-transparent border-none focus:ring-0 text-gray-700 cursor-pointer">
                    ...
                    <button type="submit" class="w-full md:w-auto bg-maroc-red hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition shadow-md flex items-center justify-center gap-2">
                        Rechercher
                    </button>
                </form>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-xl transition duration-300 group">
                    <div class="relative h-48 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1596716766417-76813296c00e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Safari" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <p class="text-gray-500 text-sm mb-4 flex-grow">Un parcours immersif au cœur de la zone Atlas pour découvrir l'histoire de notre mascotte.</p>
                        
                        <div class="border-t border-gray-100 pt-4 mt-auto">
                            <div class="flex items-center justify-between text-sm text-gray-600 mb-4">
                                <span class="flex items-center gap-2 bg-gray-100 px-2 py-1 rounded"><i class="fa-regular fa-clock"></i> 1h30</span>
                                <span class="flex items-center gap-2"><i class="fa-solid fa-user-group text-maroc-green"></i> 5 places</span>
                            </div>
                            
                            <a href="login.php?redirect=reservation" class="block w-full text-center bg-gray-100 text-gray-600 py-3 rounded-lg font-bold hover:bg-maroc-red hover:text-white transition shadow-sm group-hover:shadow-lg border border-gray-200">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-xl transition duration-300 group">
                    <div class="relative h-48 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1518709414768-a88981a4515d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Oiseaux" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                        <div class="absolute top-4 right-4 bg-maroc-green text-white font-bold px-3 py-1 rounded-md text-sm shadow-sm">
                            120 MAD
                        </div>
                    </div>
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <p class="text-gray-500 text-sm mb-4 flex-grow">Observation ornithologique guidée. Idéal pour les photographes amateurs.</p>
                        
                        <div class="border-t border-gray-100 pt-4 mt-auto">
                            <div class="flex items-center justify-between text-sm text-gray-600 mb-4">
                                <span class="flex items-center gap-2 bg-gray-100 px-2 py-1 rounded"><i class="fa-regular fa-clock"></i> 2h00</span>
                                <span class="flex items-center gap-2"><i class="fa-solid fa-user-group text-maroc-green"></i> 12 places</span>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-xl transition duration-300 group">
                    <div class="relative h-48 overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Botanique" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                        <div class="absolute top-4 right-4 bg-maroc-green text-white font-bold px-3 py-1 rounded-md text-sm shadow-sm">
                            100 MAD
                        </div>
                    </div>
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <p class="text-gray-500 text-sm mb-4 flex-grow">Comprendre l'importance de la flore pour la survie des espèces animales.</p>
                        
                        <div class="border-t border-gray-100 pt-4 mt-auto">
                            <div class="flex items-center justify-between text-sm text-gray-600 mb-4">
                                <span class="flex items-center gap-2 bg-gray-100 px-2 py-1 rounded"><i class="fa-regular fa-clock"></i> 1h00</span>
                                <span class="flex items-center gap-2"><i class="fa-solid fa-user-group text-maroc-green"></i> 20 places</span>
                            </div>
